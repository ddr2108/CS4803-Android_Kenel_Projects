...
int rawsock_connect(struct socket *sock, struct sockaddr *_addr,
							int len, int flags)
{
	struct sock *sk = sock->sk;
	...
	printk("This is coming to you from: rawsock_connect ! \n");
...
EXPORT_SYMBOL(rawsock_sendmsg);
EXPORT_SYMBOL(rawsock_recvmsg);
EXPORT_SYMBOL(rawsock_release);
EXPORT_SYMBOL(rawsock_connect);
