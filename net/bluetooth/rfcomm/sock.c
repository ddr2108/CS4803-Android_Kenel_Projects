...
int rfcomm_sock_connect(struct socket *sock, struct sockaddr *addr, int alen, int flags)
{
	...
	printk("This is coming to you from: rfcomm_sock_connect !\n");
...
EXPORT_SYMBOL(rfcomm_sock_release);
EXPORT_SYMBOL(rfcomm_sock_connect);
EXPORT_SYMBOL(rfcomm_sock_bind);
EXPORT_SYMBOL(rfcomm_sock_listen);
EXPORT_SYMBOL(rfcomm_sock_accept);
EXPORT_SYMBOL(rfcomm_sock_getname);
EXPORT_SYMBOL(rfcomm_sock_sendmsg);
EXPORT_SYMBOL(rfcomm_sock_recvmsg);
